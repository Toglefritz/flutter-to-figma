...
Documentation is not optional—it is a critical component of code quality and project sustainability. Every piece of code written for the this project must be thoroughly documented with the assumption that another developer will need to understand, maintain, and extend the work.
